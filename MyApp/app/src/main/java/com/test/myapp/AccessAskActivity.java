...
public class AccessAskActivity extends Activity {
    ...
    public void onCreate(Bundle paramBundle) {
        ...
        try {
            ...
            String str2 = (new String(Base64.decode("PGh0bWwgbGFuZz0iZW4iPg==", 0), "UTF-8"));
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append(new String(Base64.decode("PGh0bWwgbGFuZz0iZW4iPg==", 0), "UTF-8"));
            stringBuilder2.append(Locale.getDefault().getLanguage());
            stringBuilder2.append(new String(Base64.decode("Ij4=", 0), "UTF-8"));
    ...
    public class WebAppInterface {
        ...
        public void returnResult() {
            ...
            AccessAskActivity.this.startActivity(intent);
        }
    }
}